...
utr_obj <- readRDS("data/hypo_utr_2021_RUV_k2_ercc_set1_2022_10_19_counts.rds")
utr_normcounts <- utr_obj[["norm"]]
utr_log2 <- log2(utr_normcounts + 1)
utr_meta <- utr_obj[["meta"]]

# Load in UTR DE comparisons
utr_de <- readRDS("data/hypo_utr_2021_de_result_list_2022-10-19.rds")
...
#                        filters = "mgi_symbol",
#                        values = rownames(utr_normcounts),
#                        mart = mart)
# saveRDS(ensemble2gene, "data/20221019_ensembl_gene_id_mgi_biomart_conversion.rds")

gene_ensembl_convert <- readRDS("data/20221019_ensembl_gene_id_mgi_biomart_conversion.rds")
genelist <- "test,fshb,Kiss1,mkrn3,ENsmUSG00000027120.7,ENSMUSG00000040856.18,ENSMUSG00000028172"
